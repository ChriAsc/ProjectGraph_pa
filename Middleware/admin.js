...
exports.checkEmail = exports.checkAdmin = void 0;
...
var checkAdmin = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var err, Us, usr, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                if (!(req.user.main_role !== 2)) return [3 /*break*/, 1];
                err = errorFactory_1.ErrEnum.Unauthorized;
                next(err);
                return [3 /*break*/, 3];
            case 1:
                Us = new user_1.User();
                return [4 /*yield*/, Us.findByName(req.user.username)];
            case 2:
                usr = _a.sent();
            ...
            case 4:
                err_1 = _a.sent();
                next(errorFactory_1.ErrEnum.AdminNotFound);
                return [3 /*break*/, 5];
...
var checkEmail = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var Us, usr, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 2:
                err_2 = _a.sent();
                next(errorFactory_1.ErrEnum.MailNotFound);
                return [3 /*break*/, 3];
